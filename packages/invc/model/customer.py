...
class Table(object):
    def config_db(self, pkg):
        ...
        tbl.column('city', name_long='!!City', name_short='!!City')
        tbl.column('state',size='2',name_long='!!State',name_short='Pr.').relation('invc.state.code',relation_name='clients',mode='foreignkey',onDelete='raise')
